...
const tianurl     = 'http://api.tianapi.com/txapi/dujitang/index'
var count         = 0
const endNum      = 50000
...
async function verdictInclude(content){
  let sql = `SELECT id FROM dujitang WHERE content = '${content}'`
...
async function writeDataBase(content){
  let sql = 'INSERT INTO dujitang(content, created_at) VALUES(?, ?)'
